...
export const NavBar = ({ onBack, onLogout }: { onBack?: () => void; onLogout?: () => void }) => {
  ...
  >
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
      ...
      >
        {/* Sun icon */}
        <svg className="theme-icon-dark" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        {/* Moon icon */}
        <svg className="theme-icon-light" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
